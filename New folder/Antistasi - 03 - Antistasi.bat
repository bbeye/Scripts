...
SET launchID=Antistasi


REM =========  Where is ArmA installed?  ==========
SET armaPath=C:\arma3\servers\antistasi\
...
SET profileData=C:\arma3\profiles\antistasi\


REM ===========  Where are my configs?  ===========
SET configData=C:\arma3\configs\antistasi\


REM =============  Where is BattlEye?  ============
SET bePath=C:\arma3\servers\insurgency\antistasi\
